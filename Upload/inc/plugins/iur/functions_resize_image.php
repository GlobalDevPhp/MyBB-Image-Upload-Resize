<?php
/**
 * This is a modified version of MyBB functions_image.php
 * I have modified it to accept a jpg comprssion setting
 * and changed function name as not to conflict with MyBB 
 *
 * MyBB 1.8
 ...
 */
function generate_resize($file, $path, $filename, $maxheight, $maxwidth, $quality = 100)
{
	$thumb = array();
	...
	{
		check_resize_memory($imgwidth, $imgheight, $imgtype, $imgbits, $imgchan);
		...
		$scale = resize_image($imgwidth, $imgheight, $maxwidth, $maxheight);
		...
		switch($imgtype)
		{
			case 1:
				...
				break;
			case 2:
				@imagejpeg($thumbim, $path."/".$filename, $quality);
				break;
			case 3:
 ...
 * @return bool
 */
function check_resize_memory($width, $height, $type, $bitdepth, $channels)
{
